...
public class ItemAMHoe extends ItemHoe
{
    ...
    public final ObjectType<VariantToolMaterial, Block, ? extends ItemAMHoe> type;
    public final VariantToolMaterial variant;

    public ItemAMHoe(VariantsOfTypesCombo<VariantToolMaterial> owner,
                     ObjectType<VariantToolMaterial, Block, ? extends ItemAMHoe> type,
